...
|         |   3m |   6m |    1y |   3y |   5y |
|---------|------|------|-------|------|------|
| n  Fund | 3.85 |  8.1 | 23.25 | 8.16 | 9.91 |
...
|-----------------------------|--------|--------|--------|--------|--------|
| n  Fund                     |   22.3 |  14.82 | -10.23 |  27.25 |   0.33 |
...
- ·  Legal & General fund code: NRJ3

## CHARGES

| Investment management charge  (IMC)      | 0.14%   |
|------------------------------------------|---------|
| Additional expenses  (AE)                | 0.00%   |
| Fund management charge  (FMC = IMC + AE) | 0.14%   |
