...
## L&G PMC UK Equity 5% Capped Passive Fund G25
...
The fund restricts the weighting in each individual stock of the FTSE AllShare Index whose weight is above 5% of the index to 5% of the index. All remaining UK stocks are managed in proportion to their weightings in the FTSE All-Share Index.
...
|-----------------------------|--------|--------|--------|--------|--------|
| n  Fund                     |  14.04 |  13.42 |  -4.63 |  27.56 | -14.71 |
...
| n  Financials             |   25.5 |
|---------------------------|--------|
| n  Consumer Staples       |   17.3 |
| n  Industrials            |   12.6 |
| n  Consumer Discretionary |   11.8 |
| n  Health Care            |    9.6 |
| n  Energy                 |    7.4 |
| n  Basic Materials        |    6.5 |
| n  Utilities              |    4   |
| n  Real Estate            |    2.6 |
| n  Other                  |    2.6 |
...
n Top 10 holdings 37.1% n Rest of portfolio 62.9%

No. of holdings in fund 559 No. of holdings in index 554
...
| RELX Group                  |   3   |
| BP                          |   2.5 |
| London Stock Exchange Group |   2.4 |
| Rio Tinto                   |   2.3 |
| Diageo                      |   2.2 |
...
| Legal & General fund code   | B8JY         |
|-----------------------------|--------------|
| ISIN code                   | GB00BGYBWX73 |
| SEDOL code                  | BGYBWX7      |
| MEX code                    | LGTOZ        |

Fund switch: The L&G PMC UK Equity 5% Capped Passive Fund G25 (NNMY) was moved into this fund B8JY on 26 October 2018. The performance data shown before this date is for the L&G PMC UK Equity 5% Capped Passive Fund G25 (NNMY).
