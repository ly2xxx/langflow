...
## L&G PMC UK Equity 5% Capped Passive Fund 3
...
|-----------------------------|--------|--------|--------|--------|--------|
| n  Fund                     |  14.16 |  13.53 |  -4.53 |  27.69 | -14.62 |
...
- ·  Legal & General fund code: NNM3

## CHARGES

| Investment management charge  (IMC)      | 0.10%   |
|------------------------------------------|---------|
| Additional expenses  (AE)                | 0.00%   |
| Fund management charge  (FMC = IMC + AE) | 0.10%   |
